...
impl EthCall {
    async fn get_values_by_slots(slots: &HashMap<String, String>, network: &str, contract_address: &str, contract_code: &str) -> Result<HashMap<String, String>, Box<dyn std::error::Error>> {
    ...
    fn get_chain_list() -> HashMap<String, i32> {
